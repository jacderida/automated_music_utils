...
class Mp3TaggerTest(unittest.TestCase):
    ...
    def test__add_tags__disc_number_is_less_than_10__tag_should_have_a_padded_disc_number_frame(self):
        tagger = Mp3Tagger()
        tagger.add_tags('tests/integration/data/test_data.mp3', disc_number=3, disc_total=14)
        tag_data = get_id3_tag_data('tests/integration/data/test_data.mp3')
    ...
    def test__add_tags__disc_total_is_less_than_10__tag_should_have_a_padded_disc_total_frame(self):
        tagger = Mp3Tagger()
        tagger.add_tags('tests/integration/data/test_data.mp3', disc_number=3, disc_total=4)
        tag_data = get_id3_tag_data('tests/integration/data/test_data.mp3')
    ...
    def test__add_tags__all_fields_specified__tag_should_have_all_frames_set(self):
        tagger = Mp3Tagger()
        tagger.add_tags(
            'tests/integration/data/test_data.mp3', 'Aphex Twin', 'Aphex Twin', 'Drukqs',
