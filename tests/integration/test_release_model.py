...
class ReleaseModelIntegrationTest(unittest.TestCase):
    ...
    def test__from_discogs_release__release_with_single_artist_and_single_label__release_is_parsed_correctly(self):
        ...
        self.assertEqual(release.artist, 'AphexTwin')
    ...
    def test__from_discogs_release__release_is_multi_cd_with_dot_disc_track_number_separator__tracklist_is_parsed_correctly(self):
        ...
        self.assertEqual('Sardonica (Excerpt) / Barclays Bank (Excerpt) / Birth Of Baby', tracks[35].title)
        self.assertEqual(18, tracks[36].track_number)
        self.assertEqual(18, tracks[36].track_total)
        self.assertEqual('Speech Test', tracks[36].title)
    ...
    def test__from_discogs_release__release_tracklist_has_subtracks__the_tracklist_should_be_parsed_correctly(self):
        client = discogs_client.Client('amu/0.1')
        discogs_release = client.release(154321)
        discogs_release.refresh()
        release_model = ReleaseModel.from_discogs_release(discogs_release)
        tracks = release_model.get_tracks()
        self.assertEqual(13, len(tracks))
        self.assertEqual('Travelling Music', tracks[0].title)
        self.assertEqual(1, tracks[0].track_number)
        self.assertEqual(13, tracks[0].track_total)
        self.assertEqual(1, tracks[0].disc_number)
        self.assertEqual(1, tracks[0].disc_total)
        self.assertEqual('Luna Park', tracks[1].title)
        self.assertEqual(2, tracks[1].track_number)
        self.assertEqual(13, tracks[1].track_total)
        self.assertEqual(1, tracks[1].disc_number)
        self.assertEqual(1, tracks[1].disc_total)
        self.assertEqual('Two Fragments From Apocalypse: First Fragment', tracks[2].title)
        self.assertEqual(3, tracks[2].track_number)
        self.assertEqual(13, tracks[2].track_total)
        self.assertEqual(1, tracks[2].disc_number)
        self.assertEqual(1, tracks[2].disc_total)
        self.assertEqual('Two Fragments From Apocalypse: Second Fragment', tracks[3].title)
        self.assertEqual(4, tracks[3].track_number)
        self.assertEqual(13, tracks[3].track_total)
        self.assertEqual(1, tracks[3].disc_number)
        self.assertEqual(1, tracks[3].disc_total)
        self.assertEqual('Apocalypse: Part One', tracks[4].title)
        self.assertEqual(5, tracks[4].track_number)
        self.assertEqual(13, tracks[4].track_total)
        self.assertEqual(1, tracks[4].disc_number)
        self.assertEqual(1, tracks[4].disc_total)
        self.assertEqual('Apocalypse: Part Two', tracks[5].title)
        self.assertEqual(6, tracks[5].track_number)
        self.assertEqual(13, tracks[5].track_total)
        self.assertEqual(1, tracks[5].disc_number)
        self.assertEqual(1, tracks[5].disc_total)
        self.assertEqual('Apocalypse: Part Three', tracks[6].title)
        self.assertEqual(7, tracks[6].track_number)
        self.assertEqual(13, tracks[6].track_total)
        self.assertEqual(1, tracks[6].disc_number)
        self.assertEqual(1, tracks[6].disc_total)
        self.assertEqual('Apocalypse: Part Four', tracks[7].title)
        self.assertEqual(8, tracks[7].track_number)
        self.assertEqual(13, tracks[7].track_total)
        self.assertEqual(1, tracks[7].disc_number)
        self.assertEqual(1, tracks[7].disc_total)
        self.assertEqual('Drone', tracks[8].title)
        self.assertEqual(9, tracks[8].track_number)
        self.assertEqual(13, tracks[8].track_total)
        self.assertEqual(1, tracks[8].disc_number)
        self.assertEqual(1, tracks[8].disc_total)
        self.assertEqual('Four Telemetry Tapes: No. 1', tracks[9].title)
        self.assertEqual(10, tracks[9].track_number)
        self.assertEqual(13, tracks[9].track_total)
        self.assertEqual(1, tracks[9].disc_number)
        self.assertEqual(1, tracks[9].disc_total)
    ...
    def test__from_discogs_release__multi_disc_release_tracklist_has_subtracks__the_tracklist_should_be_parsed_correctly(self):
        client = discogs_client.Client('amu/0.1')
        discogs_release = client.release(6884723)
        discogs_release.refresh()
        release_model = ReleaseModel.from_discogs_release(discogs_release)
        tracks = release_model.get_tracks()
        self.assertEqual(15, len(tracks))
        self.assertEqual('18 Days: To You', tracks[0].title)
        self.assertEqual(1, tracks[0].track_number)
        self.assertEqual(6, tracks[0].track_total)
        self.assertEqual(1, tracks[0].disc_number)
        self.assertEqual(3, tracks[0].disc_total)
        self.assertEqual('18 Days: Memories', tracks[1].title)
        self.assertEqual(2, tracks[1].track_number)
        self.assertEqual(6, tracks[1].track_total)
        self.assertEqual(1, tracks[1].disc_number)
        self.assertEqual(3, tracks[1].disc_total)
        self.assertEqual('18 Days: My World', tracks[2].title)
        self.assertEqual(3, tracks[2].track_number)
        self.assertEqual(6, tracks[2].track_total)
        self.assertEqual(1, tracks[2].disc_number)
        self.assertEqual(3, tracks[2].disc_total)
        self.assertEqual('18 Days: C.C. 101.296', tracks[3].title)
        self.assertEqual(4, tracks[3].track_number)
        self.assertEqual(6, tracks[3].track_total)
        self.assertEqual(1, tracks[3].disc_number)
        self.assertEqual(3, tracks[3].disc_total)
        self.assertEqual('18 Days: Aphrodisiac', tracks[4].title)
        self.assertEqual(5, tracks[4].track_number)
        self.assertEqual(6, tracks[4].track_total)
        self.assertEqual(1, tracks[4].disc_number)
        self.assertEqual(3, tracks[4].disc_total)
        self.assertEqual('18 Days: Nang Na Nang', tracks[5].title)
        self.assertEqual(6, tracks[5].track_number)
        self.assertEqual(6, tracks[5].track_total)
        self.assertEqual(1, tracks[5].disc_number)
        self.assertEqual(3, tracks[5].disc_total)
        self.assertEqual('Oh Well', tracks[6].title)
        self.assertEqual(1, tracks[6].track_number)
        self.assertEqual(3, tracks[6].track_total)
        self.assertEqual(2, tracks[6].disc_number)
        self.assertEqual(3, tracks[6].disc_total)
        self.assertEqual('Chant Ioa', tracks[7].title)
        self.assertEqual(2, tracks[7].track_number)
        self.assertEqual(3, tracks[7].track_total)
        self.assertEqual(2, tracks[7].disc_number)
        self.assertEqual(3, tracks[7].disc_total)
        self.assertEqual('Nervous', tracks[8].title)
        self.assertEqual(3, tracks[8].track_number)
        self.assertEqual(3, tracks[8].track_total)
        self.assertEqual(2, tracks[8].disc_number)
        self.assertEqual(3, tracks[8].disc_total)
        self.assertEqual('Drone', tracks[9].title)
        self.assertEqual(1, tracks[9].track_number)
        self.assertEqual(6, tracks[9].track_total)
        self.assertEqual(3, tracks[9].disc_number)
        self.assertEqual(3, tracks[9].disc_total)
        self.assertEqual('Raga', tracks[10].title)
        self.assertEqual(2, tracks[10].track_number)
        self.assertEqual(6, tracks[10].track_total)
        self.assertEqual(3, tracks[10].disc_number)
        self.assertEqual(3, tracks[10].disc_total)
        self.assertEqual('Karma', tracks[11].title)
        self.assertEqual(3, tracks[11].track_number)
        self.assertEqual(6, tracks[11].track_total)
        self.assertEqual(3, tracks[11].disc_number)
        self.assertEqual(3, tracks[11].disc_total)
        self.assertEqual('Tablas', tracks[12].title)
        self.assertEqual(4, tracks[12].track_number)
        self.assertEqual(6, tracks[12].track_total)
        self.assertEqual(3, tracks[12].disc_number)
        self.assertEqual(3, tracks[12].disc_total)
        self.assertEqual('Clarinet Solo', tracks[13].title)
        self.assertEqual(5, tracks[13].track_number)
        self.assertEqual(6, tracks[13].track_total)
        self.assertEqual(3, tracks[13].disc_number)
        self.assertEqual(3, tracks[13].disc_total)
        self.assertEqual('Like Phil', tracks[14].title)
        self.assertEqual(6, tracks[14].track_number)
        self.assertEqual(6, tracks[14].track_total)
        self.assertEqual(3, tracks[14].disc_number)
        self.assertEqual(3, tracks[14].disc_total)
    ...
    def test__from_discogs_release__release_tracklist_has_subtracks_and_collapse_is_set__the_tracklist_should_be_parsed_correctly(self):
        client = discogs_client.Client('amu/0.1')
        discogs_release = client.release(3579489)
        discogs_release.refresh()
        release_model = ReleaseModel.from_discogs_release(discogs_release, collapse_index_tracks=True)
        tracks = release_model.get_tracks()
        self.assertEqual(7, len(tracks))
        self.assertEqual('Swastika Rising', tracks[0].title)
        self.assertEqual(1, tracks[0].track_number)
        self.assertEqual(7, tracks[0].track_total)
        self.assertEqual(1, tracks[0].disc_number)
        self.assertEqual(1, tracks[0].disc_total)
        self.assertEqual('The Third Reich', tracks[1].title)
        self.assertEqual(2, tracks[1].track_number)
        self.assertEqual(7, tracks[1].track_total)
        self.assertEqual(1, tracks[1].disc_number)
        self.assertEqual(1, tracks[1].disc_total)
        self.assertEqual('Shadows Of War: Rain Of Destruction, V1 To London', tracks[2].title)
        self.assertEqual(3, tracks[2].track_number)
        self.assertEqual(7, tracks[2].track_total)
        self.assertEqual(1, tracks[2].disc_number)
        self.assertEqual(1, tracks[2].disc_total)
        self.assertEqual('Airalert', tracks[3].title)
        self.assertEqual(4, tracks[3].track_number)
        self.assertEqual(7, tracks[3].track_total)
        self.assertEqual(1, tracks[3].disc_number)
        self.assertEqual(1, tracks[3].disc_total)
        self.assertEqual('Down In The Bunker', tracks[4].title)
        self.assertEqual(5, tracks[4].track_number)
        self.assertEqual(7, tracks[4].track_total)
        self.assertEqual(1, tracks[4].disc_number)
        self.assertEqual(1, tracks[4].disc_total)
        self.assertEqual('Raid Over Dusseldorf', tracks[5].title)
        self.assertEqual(6, tracks[5].track_number)
        self.assertEqual(7, tracks[5].track_total)
        self.assertEqual(1, tracks[5].disc_number)
        self.assertEqual(1, tracks[5].disc_total)
        self.assertEqual('1945 - Out Of The Ashes', tracks[6].title)
        self.assertEqual(7, tracks[6].track_number)
        self.assertEqual(7, tracks[6].track_total)
        self.assertEqual(1, tracks[6].disc_number)
        self.assertEqual(1, tracks[6].disc_total)

    def test__from_discogs_release__multi_disc_release_tracklist_has_non_integer_disc_number__the_tracklist_should_have_correct_integer_disc_numbers(self):
        client = discogs_client.Client('amu/0.1')
        discogs_release = client.release(26649)
        discogs_release.refresh()
        release_model = ReleaseModel.from_discogs_release(discogs_release)
        tracks = release_model.get_tracks()
        self.assertEqual(23, len(tracks))
        self.assertEqual(1, tracks[0].track_number)
        self.assertEqual(12, tracks[0].track_total)
        self.assertEqual(1, tracks[0].disc_number)
        self.assertEqual(2, tracks[0].disc_total)
        ...
        self.assertEqual(2, tracks[11].disc_total)
        self.assertEqual(1, tracks[12].track_number)
        self.assertEqual(11, tracks[12].track_total)
        self.assertEqual(2, tracks[12].disc_number)
        self.assertEqual(2, tracks[12].disc_total)
        self.assertEqual(2, tracks[13].track_number)
        self.assertEqual(11, tracks[13].track_total)
        self.assertEqual(2, tracks[13].disc_number)
        self.assertEqual(2, tracks[13].disc_total)
        self.assertEqual(3, tracks[14].track_number)
        self.assertEqual(11, tracks[14].track_total)
        self.assertEqual(2, tracks[14].disc_number)
        self.assertEqual(2, tracks[14].disc_total)
        self.assertEqual(4, tracks[15].track_number)
        self.assertEqual(11, tracks[15].track_total)
        self.assertEqual(2, tracks[15].disc_number)
        self.assertEqual(2, tracks[15].disc_total)
        self.assertEqual(5, tracks[16].track_number)
        self.assertEqual(11, tracks[16].track_total)
        self.assertEqual(2, tracks[16].disc_number)
        self.assertEqual(2, tracks[16].disc_total)
        self.assertEqual(6, tracks[17].track_number)
        self.assertEqual(11, tracks[17].track_total)
        self.assertEqual(2, tracks[17].disc_number)
        self.assertEqual(2, tracks[17].disc_total)
        self.assertEqual(7, tracks[18].track_number)
        self.assertEqual(11, tracks[18].track_total)
        self.assertEqual(2, tracks[18].disc_number)
        self.assertEqual(2, tracks[18].disc_total)
        self.assertEqual(8, tracks[19].track_number)
        self.assertEqual(11, tracks[19].track_total)
        self.assertEqual(2, tracks[19].disc_number)
        self.assertEqual(2, tracks[19].disc_total)
        self.assertEqual(9, tracks[20].track_number)
        self.assertEqual(11, tracks[20].track_total)
        self.assertEqual(2, tracks[20].disc_number)
        self.assertEqual(2, tracks[20].disc_total)
        self.assertEqual(10, tracks[21].track_number)
        self.assertEqual(11, tracks[21].track_total)
        self.assertEqual(2, tracks[21].disc_number)
        self.assertEqual(2, tracks[21].disc_total)
        self.assertEqual(11, tracks[22].track_number)
        self.assertEqual(11, tracks[22].track_total)
        self.assertEqual(2, tracks[22].disc_number)
        self.assertEqual(2, tracks[22].disc_total)
