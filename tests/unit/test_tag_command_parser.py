...
class TagCommandParserTest(unittest.TestCase):
    ...
    def test__parse_add_tag_command__source_is_file__returns_single_add_mp3_tag_command(self, isfile_mock):
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__artist_is_specified__add_mp3_tag_command_has_artist_correctly_specified(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__album_artist_is_specified__add_mp3_tag_command_has_album_artist_correctly_specified(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__album_is_specified__add_mp3_tag_command_has_album_correctly_specified(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__title_is_specified__add_mp3_tag_command_has_title_correctly_specified(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__year_is_specified__add_mp3_tag_command_has_year_correctly_specified(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__genre_is_specified__add_mp3_tag_command_has_genre_correctly_specified(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__comment_is_specified__add_mp3_tag_command_has_comment_correctly_specified(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_file_and_no_track_number_is_specified__add_mp3_tag_command_has_track_number_set_to_1(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_file_and_no_track_number_is_specified__add_mp3_tag_command_has_track_total_set_to_1(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    def test__parse_add_tag_command__source_is_file_and_no_disc_number_is_specified__add_mp3_tag_command_has_disc_number_set_to_1(self, config_mock, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_file_and_no_disc_number_is_specified__add_mp3_tag_command_has_disc_total_set_to_1(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_file_and_track_number_is_specified__add_mp3_tag_command_has_track_number_set(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_file_and_track_total_is_specified__add_mp3_tag_command_has_track_total_set(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_file_and_disc_number_is_specified__add_mp3_tag_command_has_disc_number_set(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_file_and_disc_total_is_specified__add_mp3_tag_command_has_disc_total_set(self, isfile_mock):
        isfile_mock.return_value = True
        command_args = AddTagCommandArgs()
        command_args.source = '/some/path/to/song.mp3'
        command_args.artist = 'Aphex Twin'
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_directory_with_4_mp3s__returns_4_add_mp3_tag_commands_with_correct_source(self, isfile_mock, walk_mock):
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__walk_returns_files_in_arbitrary_order__returns_4_add_mp3_tag_commands_with_correct_source(self, isfile_mock, walk_mock):
        walk_mock.return_value = [
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_directory_with_4_mp3s__returns_4_add_mp3_tag_commands_with_correct_track_numbers(self, isfile_mock, walk_mock):
        walk_mock.return_value = [
            ('/some/path/to/mp3s', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3'))
        ]
        isfile_mock.return_value = False
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_directory_with_4_mp3s__returns_4_add_mp3_tag_commands_with_correct_track_totals(self, isfile_mock, walk_mock):
        walk_mock.return_value = [
            ('/some/path/to/mp3s', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3'))
        ]
        isfile_mock.return_value = False
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_multi_cd_directory__returns_8_add_mp3_tag_commands_with_correct_source(self, isfile_mock, walk_mock, listdir_mock):
        walk_mock.return_value = [
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_multi_cd_directory_and_walk_returns_directories_in_arbitrary_order__returns_16_add_mp3_tag_commands_with_correct_source(self, isfile_mock, walk_mock, listdir_mock):
        walk_mock.return_value = [
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_multi_cd_directory__returns_8_add_mp3_tag_commands_with_correct_track_numbers(self, isfile_mock, walk_mock, listdir_mock):
        walk_mock.return_value = [
            ('/some/path/to/mp3s', ('cd1', 'cd2'), ()),
            ('/some/path/to/mp3s/cd1', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3')),
            ('/some/path/to/mp3s/cd2', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3'))
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_multi_cd_directory__returns_8_add_mp3_tag_commands_with_correct_track_totals(self, isfile_mock, walk_mock, listdir_mock):
        walk_mock.return_value = [
            ('/some/path/to/mp3s', ('cd1', 'cd2'), ()),
            ('/some/path/to/mp3s/cd1', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3')),
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_multi_cd_directory__returns_8_add_mp3_tag_commands_with_correct_disc_numbers(self, isfile_mock, walk_mock, listdir_mock):
        walk_mock.return_value = [
            ('/some/path/to/mp3s', ('cd1', 'cd2'), ()),
            ('/some/path/to/mp3s/cd1', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3')),
            ('/some/path/to/mp3s/cd2', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3'))
    ...
    @mock.patch('os.walk')
    @mock.patch('os.path.isfile')
    def test__parse_add_tag_command__source_is_multi_cd_directory__returns_8_add_mp3_tag_commands_with_correct_disc_totals(self, isfile_mock, walk_mock, listdir_mock):
        walk_mock.return_value = [
            ('/some/path/to/mp3s', ('cd1', 'cd2'), ()),
            ('/some/path/to/mp3s/cd1', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3')),
            ('/some/path/to/mp3s/cd2', (), ('01 - Track 1.mp3', '02 - Track 2.mp3', '03 - Track 3.mp3', '04 - Track 4.mp3'))
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__release_artist_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__title_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__genre_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__comment_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
        ...
        self.assertEqual('Bunker Records (BUNKER 3002)', commands[2].comment)
        self.assertEqual('Bunker Records (BUNKER 3002)', commands[3].comment)
        self.assertEqual('Bunker Records (BUNKER 3002)', commands[4].comment)
        self.assertEqual('Bunker Records (BUNKER 3002)', commands[5].comment)

    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__original_year_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__track_number_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__track_total_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__disc_number_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__disc_total_is_set_on_tracks(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_single_artist_and_6_tracks__source_is_set_correctly(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__walk_returns_tracks_in_arbitrary_order__sources_are_specified_in_correct_order(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_artists_on_tracks__artists_are_set_correctly(self, walk_mock):
        release_model = ReleaseModel()
    ...
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_has_artists_on_tracks__album_artists_are_set_correctly(self, walk_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__source_is_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = 'Selected Ambient Works Volume II'
        release_model.label = 'Warp Records'
    ...
    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__titles_are_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
    ...
    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__artists_are_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = '26 Mixes For Cash'
        release_model.label = 'Warp Records'
    ...
    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__album_artists_are_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = '26 Mixes For Cash'
        release_model.label = 'Warp Records'
        ...
        self.assertEqual('Aphex Twin', commands[2].album_artist)
        self.assertEqual('Aphex Twin', commands[3].album_artist)
        self.assertEqual('Aphex Twin', commands[4].album_artist)
        self.assertEqual('Aphex Twin', commands[5].album_artist)
        self.assertEqual('Aphex Twin', commands[6].album_artist)
        self.assertEqual('Aphex Twin', commands[7].album_artist)
        self.assertEqual('Aphex Twin', commands[8].album_artist)
        self.assertEqual('Aphex Twin', commands[9].album_artist)
        self.assertEqual('Aphex Twin', commands[10].album_artist)
        self.assertEqual('Aphex Twin', commands[11].album_artist)
        self.assertEqual('Aphex Twin', commands[12].album_artist)
        self.assertEqual('Aphex Twin', commands[13].album_artist)
        self.assertEqual('Aphex Twin', commands[14].album_artist)
        self.assertEqual('Aphex Twin', commands[15].album_artist)
        self.assertEqual('Aphex Twin', commands[16].album_artist)
        self.assertEqual('Aphex Twin', commands[17].album_artist)
        self.assertEqual('Aphex Twin', commands[18].album_artist)
        self.assertEqual('Aphex Twin', commands[19].album_artist)
        self.assertEqual('Aphex Twin', commands[20].album_artist)
        self.assertEqual('Aphex Twin', commands[21].album_artist)
        self.assertEqual('Aphex Twin', commands[22].album_artist)
        self.assertEqual('Aphex Twin', commands[23].album_artist)
        self.assertEqual('Aphex Twin', commands[24].album_artist)
        self.assertEqual('Aphex Twin', commands[25].album_artist)

    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__track_numbers_are_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = 'Selected Ambient Works Volume II'
        release_model.label = 'Warp Records'
    ...
    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__track_totals_are_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = 'Selected Ambient Works Volume II'
        release_model.label = 'Warp Records'
    ...
    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__disc_numbers_are_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = 'Selected Ambient Works Volume II'
        release_model.label = 'Warp Records'
    ...
    @mock.patch('os.listdir')
    @mock.patch('os.walk')
    def test__parse_from_release_model__release_is_multi_cd__disc_totals_are_set_correctly(self, walk_mock, listdir_mock):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = 'Selected Ambient Works Volume II'
        release_model.label = 'Warp Records'
        ...
        self.assertEqual(2, commands[6].disc_total)
        self.assertEqual(2, commands[7].disc_total)
        self.assertEqual(2, commands[8].disc_total)
        self.assertEqual(2, commands[9].disc_total)
        self.assertEqual(2, commands[10].disc_total)
        self.assertEqual(2, commands[11].disc_total)
        self.assertEqual(2, commands[12].disc_total)
        self.assertEqual(2, commands[13].disc_total)
        self.assertEqual(2, commands[14].disc_total)
        self.assertEqual(2, commands[15].disc_total)
        self.assertEqual(2, commands[16].disc_total)
        self.assertEqual(2, commands[17].disc_total)
        self.assertEqual(2, commands[18].disc_total)
        self.assertEqual(2, commands[19].disc_total)
        self.assertEqual(2, commands[20].disc_total)
        self.assertEqual(2, commands[21].disc_total)
        self.assertEqual(2, commands[22].disc_total)
        self.assertEqual(2, commands[23].disc_total)

    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__4_add_tag_commands_are_generated(self):
        release_model = ReleaseModel()
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__sources_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_13_tracks__sources_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__artists_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__album_is_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__genre_is_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__comment_is_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
        ...
        self.assertEqual('Rephlex (ANALORD 08)', commands[2].comment)
        self.assertEqual('Rephlex (ANALORD 08)', commands[3].comment)

    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__track_numbers_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__track_totals_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__disc_numbers_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__disc_totals_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_4_tracks__original_year_is_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'AFX'
        release_model.title = 'Analord 08'
        release_model.label = 'Rephlex'
    ...
    def test__parse_from_release_model_with_empty_source__release_has_artists_on_tracks__artists_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_and_sources_have_different_lengths__command_parsing_error_is_raise(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__sources_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_13_tracks__sources_are_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Aphex Twin'
        release_model.title = 'Selected Ambient Works 85-92'
        release_model.label = 'Apollo'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__artists_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__genres_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__comments_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
        ...
        self.assertEqual('Bunker Records (BUNKER 3047)', commands[2].comment)
        self.assertEqual('Bunker Records (BUNKER 3047)', commands[3].comment)
        self.assertEqual('Bunker Records (BUNKER 3047)', commands[4].comment)
        self.assertEqual('Bunker Records (BUNKER 3047)', commands[5].comment)

    def test__parse_from_release_model_with_sources__release_has_6_tracks__track_numbers_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__track_totals_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__disc_numbers_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__disc_totals_are_set_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    def test__parse_from_release_model_with_sources__release_has_6_tracks__original_year_is_specified_correctly(self):
        release_model = ReleaseModel()
        release_model.artist = 'Various'
        release_model.title = 'Bronson Quest'
        release_model.label = 'Bunker Records'
    ...
    @mock.patch('os.path.isfile')
    def test__parse_remove_mp3_tag_command__source_is_single_file__a_single_command_should_be_returned(self, isfile_mock):
        isfile_mock.return_value = True
