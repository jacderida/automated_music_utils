...
class RubyRipperCdRipperTest(unittest.TestCase):
    ...
    def test__rip_cd__call_ruby_ripper_with_correct_args__ruby_ripper_is_called_with_correct_args(self, subprocess_mock, config_mock, open_mock, mkdir_mock, copy_content_mock, rm_mock):
    ...
    @mock.patch('amu.rip.ConfigurationProvider', autospec=True)
    @mock.patch('amu.rip.subprocess.Popen')
    def test__rip_cd__create_temp_directory_for_output__temp_directory_is_created(self, subprocess_mock, config_mock, open_mock, gettempdir_mock, mkdir_mock, copy_content_mock, rm_mock):
    ...
    @mock.patch('amu.rip.ConfigurationProvider', autospec=True)
    @mock.patch('amu.rip.subprocess.Popen')
    def test__rip_cd__temporary_directory_has_guid__temp_directory_created_with_guid(self, subprocess_mock, config_mock, open_mock, gettempdir_mock, mkdir_mock, copy_content_mock, rm_mock):
    ...
    @mock.patch('amu.rip.ConfigurationProvider', autospec=True)
    @mock.patch('amu.rip.subprocess.Popen')
    def test__rip_cd__the_os_should_be_used_to_get_temp_dir__os_temp_dir_is_used(self, subprocess_mock, config_mock, open_mock, gettempdir_mock, mkdir_mock, copy_content_mock, rm_mock):
        open_mock.return_value = MagicMock(spec=file)
        config_mock.get_ruby_ripper_path.return_value = \
            '/opt/rubyripper/rubyripper_cli'
        config_mock.get_temp_config_file_for_ripper.return_value = \
    ...
    @mock.patch('amu.rip.ConfigurationProvider', autospec=True)
    @mock.patch('amu.rip.subprocess.Popen')
    def test__rip_cd__ripper_should_use_temp_directory_as_destination__temp_directory_is_destination(self, subprocess_mock, config_mock, open_mock, gettempdir_mock, mkdir_mock, copy_content_mock, rm_mock):
        copy_mock = self.copy_call_args(mkdir_mock)
        gettempdir_mock.return_value = '/tmp' # Mocking for platform agnosticism.
        open_mock.return_value = MagicMock(spec=file)
        config_mock.get_ruby_ripper_path.return_value = \
    ...
    @mock.patch('amu.rip.ConfigurationProvider', autospec=True)
    @mock.patch('amu.rip.subprocess.Popen')
    def test__rip_cd__temp_output_should_be_copied_to_destination__temp_output_is_copied_to_destination(self, subprocess_mock, config_mock, open_mock, gettempdir_mock, mkdir_mock, copy_content_mock, rm_mock):
        copy_mock = self.copy_call_args(mkdir_mock)
        gettempdir_mock.return_value = '/tmp' # Mocking for platform agnosticism.
        open_mock.return_value = MagicMock(spec=file)
        config_mock.get_ruby_ripper_path.return_value = \
    ...
    @mock.patch('amu.rip.ConfigurationProvider', autospec=True)
    @mock.patch('amu.rip.subprocess.Popen')
    def test__rip_cd__temp_directory_should_be_removed__temp_directory_is_removed(self, subprocess_mock, config_mock, open_mock, gettempdir_mock, mkdir_mock, copy_content_mock, rm_mock):
        copy_mock = self.copy_call_args(mkdir_mock)
        gettempdir_mock.return_value = '/tmp' # Mocking for platform agnosticism.
        open_mock.return_value = MagicMock(spec=file)
        config_mock.get_ruby_ripper_path.return_value = \
