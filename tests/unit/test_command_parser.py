...
class CommandParserTest(unittest.TestCase):
    ...
    @mock.patch('amu.parsing.ArtworkCommandParser.parse_from_encode_commands')
    @mock.patch('amu.parsing.EncodeCommandParser.parse_wav')
    def test__from_args__encode_wav_to_mp3_command_with_discogs_id_specified_and_use_genre_is_false__the_genre_selector_should_not_be_used(self, encode_command_parser_mock, artwork_command_parser_mock, move_file_command_parser_mock):
        config_mock, cd_ripper_mock, encoder_mock, metadata_mock, tagger_mock, genre_selector_mock = (Mock(),)*6
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
        ...
        release_model.add_track_directly(None, 'Backdoor.Spyboter.A', 4, 4, 1, 1)
        metadata_mock.get_release_by_id.return_value = release_model
        config_mock.use_genre.return_value = False

        parser = CommandParser(config_mock, cd_ripper_mock, metadata_mock, genre_selector_mock)
        parser.from_args(args)
        self.assertEqual(0, genre_selector_mock.select_genre.call_count)
    ...
    @mock.patch('amu.parsing.MoveAudioFileCommandParser.parse_from_encode_commands')
    @mock.patch('amu.parsing.EncodeCommandParser.parse_cd_rip')
    def test__from_args__encode_cd_to_mp3_command_with_discogs_id_specified__it_should_use_the_genre_selector(self, encode_command_parser_mock, move_file_command_parser_mock, gettempdir_mock):
        config_mock, cd_ripper_mock, encoder_mock, metadata_mock, genre_selector_mock = (Mock(),)*5
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
    ...
    def test__from_args__when_add_mp3_tag_is_specified_with_a_discogs_id__it_should_call_the_tag_command_parser_with_the_correct_arguments(self, tag_command_parser_mock, move_file_command_parser_mock):
        ...
        config_mock, cd_ripper_mock, metadata_mock, tagger_mock, genre_selector_mock = (Mock(),)*5
        metadata_mock.get_release_by_id.return_value = release_model
        genre_selector_mock.select_genre.return_value = 'Electronic'
        tag_command_parser_mock.return_value = [
            AddTagCommand(config_mock, tagger_mock),
    ...
    @mock.patch('amu.parsing.MoveAudioFileCommandParser.parse_from_release_model')
    @mock.patch('amu.parsing.TagCommandParser.parse_from_release_model')
    def test__from_args__when_add_mp3_tag_is_specified_with_a_discogs_id_and_use_genre_is_false__it_should_not_use_the_genre_selector(self, tag_command_parser_mock, move_file_command_parser_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'tag',
    ...
    @mock.patch('amu.parsing.DecodeCommandParser.parse_decode_command')
    def test__from_args__when_a_decode_command_is_specified__it_should_use_the_decode_command_parser(self, decode_parser_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'decode',
    ...
    @mock.patch('os.getcwd')
    @mock.patch('amu.parsing.DecodeCommandParser.parse_decode_command')
    def test__from_args__when_a_decode_command_is_specified_with_no_destination__it_should_use_the_current_working_directory_as_the_destination(self, decode_parser_mock, getcwd_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'decode',
    ...
    @mock.patch('amu.parsing.MoveAudioFileCommandParser.parse_from_release_model')
    @mock.patch('amu.parsing.TagCommandParser.parse_from_release_model')
    def test__from_args__when_add_mp3_tag_is_specified_with_a_discogs_id_and_collapse_index_tracks__it_should_call_the_move_file_command_parser_with_the_correct_arguments(self, tag_command_parser_mock, move_file_command_parser_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'tag',
