...
class CommandParserTest(unittest.TestCase):
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_wav_to_mp3_command_with_discogs_id_specified__the_mask_replacer_is_called_to_replace_the_directory(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, metadata_mock, maskreplacer_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_wav_to_mp3_command_with_discogs_id_specified__the_release_should_only_be_fetched_once(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_wav_to_mp3_command_with_discogs_id_specified__the_encode_command_parser_should_be_called_correctly(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_wav_to_mp3_command_with_discogs_id_specified__the_config_provider_should_be_used_to_get_the_directory_mask(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_wav_to_mp3_command_with_discogs_id_specified_and_destination_is_overriden__the_destination_override_should_be_used(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_wav_to_mp3_command_with_discogs_id_specified__4_move_audio_file_commands_are_generated(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_cd_to_mp3_command_with_discogs_id_specified__the_encode_command_parser_should_use_the_correct_destination(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, number_of_tracks_mock, gettempdir_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_cd_to_mp3_command_with_discogs_id_specified__the_release_should_only_be_fetched_once(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, number_of_tracks_mock, gettempdir_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_cd_to_mp3_command_with_discogs_id_specified_and_destination_is_overriden__the_destination_override_should_be_used(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, number_of_tracks_mock, gettempdir_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
    ...
    @mock.patch('amu.rip.RubyRipperCdRipper')
    @mock.patch('amu.config.ConfigurationProvider')
    def test__from_args__encode_cd_to_mp3_command__12_move_audio_file_commands_are_generated(self, config_mock, cd_ripper_mock, encoder_mock, encode_command_parser_mock, number_of_tracks_mock, gettempdir_mock, metadata_mock):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'encode',
