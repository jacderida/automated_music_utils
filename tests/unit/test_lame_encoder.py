...
class LameEncoderTest(unittest.TestCase):
    ...
    def test__encode__lame_is_used_as_encoder__lame_is_called_with_the_correct_args(self, exists_mock, isdir_mock, subprocess_mock, open_mock):
    ...
    @mock.patch('os.path.exists')
    def test__encode__source_is_non_existent__throws_configuration_exception(self, exists_mock):
