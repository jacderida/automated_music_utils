...
class EncodeCommandParserTest(unittest.TestCase):
    ...
    @mock.patch('amu.config.ConfigurationProvider')
    @mock.patch('amu.rip.RubyRipperCdRipper')
    def test__parse_wav_to_mp3__source_does_not_exist__throws_command_parsing_exception(self, config_mock, cd_ripper_mock, encoder_mock, isfile_mock, exists_mock):
