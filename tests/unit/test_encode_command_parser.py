...
class EncodeCommandParserTest(unittest.TestCase):
    ...
    @mock.patch('amu.config.ConfigurationProvider')
    @mock.patch('amu.rip.RubyRipperCdRipper')
    def test__parse_wav_to_mp3__source_is_multi_cd_release__returns_9_correctly_specified_encode_wav_to_mp3_commands(self, config_mock, cd_ripper_mock, encoder_mock, isfile_mock, exists_mock, walk_mock, listdir_mock):
        exists_mock.return_value = True
        isfile_mock.return_value = False
        walk_mock.return_value = [
    ...
    @mock.patch('amu.config.ConfigurationProvider')
    @mock.patch('amu.rip.RubyRipperCdRipper')
    def test__parse_cd_to_mp3__track_count_is_less_than_one__throws_command_parsing_exception(self, config_mock, cd_ripper_mock, encoder_mock):
