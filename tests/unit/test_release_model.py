...
class ReleaseModelTest(unittest.TestCase):
    ...
    def test__repr__populated_release_model__should_print_out_the_country(self):
        release_model = ReleaseModel()
        release_model.discogs_id = 12345
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
        ...
        with captured_output() as (out, _):
            print release_model
            output = out.getvalue().strip()
            self.assertIn('Country: Netherlands', output)

    def test__repr__populated_release_model__should_print_out_the_release_year(self):
        release_model = ReleaseModel()
        release_model.discogs_id = 12345
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
    ...
    def test__repr__populated_release_model__should_print_out_the_style(self):
        ...
        with captured_output() as (out, _):
            print release_model
            output = out.getvalue().strip()
            self.assertIn('Style: Electro', output)

    def test__repr__populated_release_model__should_print_out_the_tracklist(self):
        release_model = ReleaseModel()
        release_model.discogs_id = 12345
        release_model.artist = 'Legowelt'
        release_model.title = 'Pimpshifter'
