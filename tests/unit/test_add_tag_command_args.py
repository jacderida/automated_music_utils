...
class AddTagCommandArgsTest(unittest.TestCase):
    ...
    def test__from_mix_command__when_passed_args_for_mix_command__the_source_should_be_specified_correctly(self):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'mix',
        ...
        self.assertEqual(command_args.source, '/some/source/mix.mp3')

    def test__from_mix_command__when_passed_args_for_mix_command__the_artist_should_be_specified_correctly(self):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'mix',
        ...
        command_args = AddTagCommandArgs.from_mix_command(args)
        self.assertEqual(command_args.artist, 'Autechre')

    def test__from_mix_command__when_passed_args_for_mix_command__the_album_should_be_specified_correctly(self):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'mix',
        ...
        command_args = AddTagCommandArgs.from_mix_command(args)
        self.assertEqual(command_args.album, 'Xltronic Marathon')

    def test__from_mix_command__when_passed_args_for_mix_command__the_title_should_be_specified_correctly(self):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'mix',
        ...
        command_args = AddTagCommandArgs.from_mix_command(args)
        self.assertEqual(command_args.title, 'Xltronic Marathon')

    def test__from_mix_command__when_passed_args_for_mix_command__the_year_should_be_specified_correctly(self):
        driver = CliDriver()
        arg_parser = driver.get_argument_parser()
        args = arg_parser.parse_args([
            'mix',
